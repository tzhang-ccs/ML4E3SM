if (CMAKE_SYSTEM_PROCESSOR MATCHES "^aarch64")
  string(APPEND CFLAGS "-mcmodel=small -I/lcrc/group/e3sm/ac.tzhang/conda/envs/tensorflow/include/python3.11")
  string(APPEND FFLAGS "-mcmodel=small")
else()
  string(APPEND CFLAGS "-mcmodel=medium -I/lcrc/group/e3sm/ac.tzhang/conda/envs/tensorflow/include/python3.11")
...
string(APPEND LDFLAGS " -fPIC  -dynamic -Wl,-rpath /lcrc/group/e3sm/ac.tzhang/conda/envs/tensorflow/lib -L/lcrc/group/e3sm/ac.tzhang/conda/envs/tensorflow/lib -lpython3.11")
if (compile_threaded)
