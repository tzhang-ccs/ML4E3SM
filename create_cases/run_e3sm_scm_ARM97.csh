...
#######  BEGIN USER DEFINED SETTINGS
  ...
  setenv casename e3sm_scm_ARM97

  # Set the case directory here
  setenv casedirectory /lcrc/group/e3sm/ac.tzhang/E3SMv2_1/SCM/

  # Directory where code lives
  setenv code_dir /home/ac.tzhang/E3SM/

  # Code tag name
  setenv code_tag E3SMv2_1
...
# End Case specific stuff here
  ...
  if ($e3sm_version == v1) then
    ...
    if ($e3sm_version == v2) set compset = FSCM
